...
// wrapper so both never drift. Mirrors apps/creator (separate origin, separate
// cookie jar) — kept per-app on purpose.

import { cookies } from 'next/headers';
import { AppClient } from '@fundi/types';

/**
 * This app's client identity (learner PWA). Carried as the `app` field on every
